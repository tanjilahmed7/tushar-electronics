...
const PATH = '/reports/fee-summary';
...
export default function FeeSummaryReport({ totalFee, bySim, sims, filters }: Props) {
            ...
            <div className="flex h-full flex-1 flex-col gap-6 overflow-x-auto p-6 md:p-8">
                <div>
                    ...
                    <p className="mt-1 text-base text-muted-foreground">
                        মাস বা নির্দিষ্ট তারিখ পরিসর অনুযায়ী মোট ফি ও লেনদেন সংখ্যা
                    </p>
                </div>
                ...
                <Card className="border-border">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-lg font-semibold">সিম অনুযায়ী ফি</CardTitle>
                        <CardDescription className="text-base">
                            প্রতিটি সিমে কাটা ফির যোগফল ও লেনদেন সংখ্যা
                        </CardDescription>
                    </CardHeader>
                                ...
                                <tbody>
                                    {bySim.length === 0 ? (
                                        <tr>
                                            ...
                                            >
                                                এই সময়ের মধ্যে কোনো ফি রেকর্ড নেই।
                                            </td>
                                        </tr>
                                    ) : (
                                        bySim.map((row) => (
