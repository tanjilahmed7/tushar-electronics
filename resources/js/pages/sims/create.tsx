...
const breadcrumbs: BreadcrumbItem[] = [
    ...
    { title: 'নতুন সিম যোগ করুন', href: `${SIMS_PATH}/create` },
];
                    ...
                    <CardContent>
                        <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                            ...
                            <div className="flex gap-3">
                                <Button type="submit" className="h-12 text-base px-6" disabled={processing} data-test="sim-store-button">
